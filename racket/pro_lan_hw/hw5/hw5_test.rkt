...
(define tests
  (test-suite
   ...
   (check-equal? (eval-exp (ifgreater (int 3) (int 3) (int 3) (int 2))) (int 2) "ifgreater test")
   (check-equal? (eval-exp (ifgreater (int 5) (int 3) (int 3) (int 2))) (int 3) "ifgreater test")
   ...
   (check-equal? (eval-exp (apair (int 2) (add (int 3) (int -2)))) (apair (int 2) (int 1)) "apair test")

   (check-equal? (eval-exp (fst (apair (int 2) (add (int 3) (int -2))))) (int 2) "fst test")
   (check-equal? (eval-exp (snd (apair (int 2) (add (int 3) (int -2))))) (int 1) "snd test")
   ...
   (check-equal? (eval-exp (mlet* (list (cons "x" (int 10)) (cons "y" (int 11))) (add (var "x") (var "y")))) (int 21) "mlet* test")
