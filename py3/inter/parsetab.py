...
_lr_productions = [
  ...
  ('statement -> NAME = expression','statement',3,'p_statement_assign','calc2.py',47),
  ('statement -> expression','statement',1,'p_statement_expr','calc2.py',52),
  ('expression -> expression + expression','expression',3,'p_expression_binop','calc2.py',57),
  ('expression -> expression - expression','expression',3,'p_expression_binop','calc2.py',58),
  ('expression -> expression * expression','expression',3,'p_expression_binop','calc2.py',59),
  ('expression -> expression / expression','expression',3,'p_expression_binop','calc2.py',60),
  ('expression -> - expression','expression',2,'p_expression_uminus','calc2.py',72),
  ('expression -> ( expression )','expression',3,'p_expression_group','calc2.py',77),
  ('expression -> NUMBER','expression',1,'p_expression_number','calc2.py',82),
  ('expression -> NAME','expression',1,'p_expression_name','calc2.py',87),
]
